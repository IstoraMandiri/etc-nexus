...
|--------|-----------|----------|--------|
| core-geth | 53,613 | TBD | Running |
| besu-etc | 53,613 | TBD | Running |
| nethermind-etc | 53,613 | TBD | Running |

- **Total:** 160,839 tests completed (170 failures)
- **Rate:** ~25 tests/min (all clients combined), ~8.3 tests/min per client
- **Elapsed:** 109h / 4.5 days (started 2026-02-06 13:07 UTC)
- **Current test:** `sstore_combinations_initial20` — SSTORE combination tests (Istanbul/Berlin)
- **Fork coverage:** Frontier (3,624), Homestead (6,894), EIP150 (4,122), EIP158 (4,125), Byzantium (15,456), Constantinople (32,922), ConstantinopleFix (32,907), Istanbul (28,308), Berlin (31,467)
...
- **Note:** 160.8k tests (53.6k per client). 109h / 4.5 days. In sstore_combinations_initial20 for Istanbul/Berlin. Failures stable at 170.
