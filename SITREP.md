...
Last updated: 2026-02-08 22:26 UTC
...
|--------|-----------|----------|--------|
| core-geth | 29,040 | TBD | Running |
| besu-etc | 29,039 | TBD | Running |
| nethermind-etc | 29,039 | TBD | Running |

- **Total:** 87,118 tests completed (40 failures)
- **Rate:** ~26 tests/min (all clients combined), ~8.6 tests/min per client
- **Elapsed:** 57h (started 2026-02-06 13:07 UTC)
- **Current test:** `pointMulAdd` — cryptographic point multiplication tests (all forks)
- **Fork coverage:** Frontier (2,751), Homestead (5,743), EIP150 (3,009), EIP158 (3,054), Byzantium (12,633), Constantinople (29,973), ConstantinopleFix (29,956)
...
- **Note:** Past 87k tests (29k per client). 57h elapsed. Istanbul/Berlin still not reached.
