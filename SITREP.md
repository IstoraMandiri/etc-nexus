...
|--------|-----------|----------|--------|
| core-geth | 48,169 | TBD | Running |
| besu-etc | 48,169 | TBD | Running |
| nethermind-etc | 48,169 | TBD | Running |

- **Total:** 144,507 tests completed (170 failures)
- **Rate:** ~25 tests/min (all clients combined), ~8.3 tests/min per client
- **Elapsed:** 98h / 4+ days (started 2026-02-06 13:07 UTC)
- **Current test:** `sstore_combinations_initial01` — SSTORE combination tests (Istanbul/Berlin)
- **Fork coverage:** Frontier (3,624), Homestead (6,894), EIP150 (4,122), EIP158 (4,125), Byzantium (15,456), Constantinople (32,922), ConstantinopleFix (32,907), Istanbul (20,179), Berlin (23,263)
...
- **Note:** 144.5k tests (48.2k per client). 98h / 4+ days. In sstore_combinations_initial01 for Istanbul/Berlin. Failures stable at 170.
