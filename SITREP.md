...
Last updated: 2026-02-11 12:21 UTC
...
|--------|-----------|----------|--------|
| core-geth | 58,447 | TBD | Running |
| besu-etc | 58,447 | TBD | Running |
| nethermind-etc | 58,447 | TBD | Running |

- **Total:** 175,341 tests completed (174 failures)
- **Rate:** ~25 tests/min (all clients combined), ~8.3 tests/min per client
- **Elapsed:** 119h / ~5 days (started 2026-02-06 13:07 UTC)
- **Current test:** `ecmul` — EC multiplication precompile tests (Istanbul/Berlin)
- **Fork coverage:** Frontier (3,924), Homestead (7,194), EIP150 (4,422), EIP158 (4,425), Byzantium (15,756), Constantinople (33,222), ConstantinopleFix (33,207), Istanbul (34,506), Berlin (37,671)
...
- **Note:** 175.3k tests (58.4k per client). 119h / ~5 days. Running ecmul precompile tests (Istanbul/Berlin-specific, high data index count). Failures stable at 174.
