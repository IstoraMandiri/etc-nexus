...
Last updated: 2026-02-10 05:52 UTC
...
|--------|-----------|----------|--------|
| core-geth | 43,745 | TBD | Running |
| besu-etc | 43,744 | TBD | Running |
| nethermind-etc | 43,744 | TBD | Running |

- **Total:** 131,233 tests completed (168 failures)
- **Rate:** ~26 tests/min (all clients combined), ~8.6 tests/min per client
- **Elapsed:** 88h / 3.7 days (started 2026-02-06 13:07 UTC)
- **Current test:** `sstore_XtoXto0` — SSTORE gas cost tests (Istanbul/Berlin)
...
- **Note:** Past 131k tests (43.7k per client). 88h / 3.7 days. Failures stable at 168.
