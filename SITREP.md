...
Last updated: 2026-02-08 23:27 UTC
...
|--------|-----------|----------|--------|
| core-geth | 29,570 | TBD | Running |
| besu-etc | 29,570 | TBD | Running |
| nethermind-etc | 29,570 | TBD | Running |

- **Total:** 88,710 tests completed (40 failures)
- **Rate:** ~26 tests/min (all clients combined), ~8.6 tests/min per client
- **Elapsed:** 58h (started 2026-02-06 13:07 UTC)
- **Current test:** `ecadd`/`ecmul` — elliptic curve addition/multiplication tests (all forks)
- **Fork coverage:** Frontier (2,787), Homestead (5,793), EIP150 (3,045), EIP158 (3,090), Byzantium (13,111), Constantinople (30,450), ConstantinopleFix (30,432)
...
- **Note:** Past 88k tests (29.5k per client). 58h elapsed. Istanbul/Berlin still not reached.
