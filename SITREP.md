...
|--------|-----------|----------|--------|
| core-geth | 14,960 | TBD | Running |
| besu-etc | 14,959 | TBD | Running |
| nethermind-etc | 14,959 | TBD | Running |

- **Total:** 44,878 tests completed (34 failures)
- **Rate:** ~26 tests/min (all clients combined), ~8.6 tests/min per client
- **Elapsed:** 28h 59m (started 2026-02-06 13:07 UTC)
- **Current test:** `sstore_combinations_initial0` (d1129) — massive sstore combo tests (Constantinople/ConstantinopleFix)
- **Fork coverage:** Frontier (2,145), Homestead (4,323), EIP150 (2,394), EIP158 (2,799), Byzantium (9,606), Constantinople (11,812), ConstantinopleFix (11,798)
...
- **Note:** Past 44k tests. No new failures since 10k mark. Istanbul/Berlin still not reached. 29h elapsed.
