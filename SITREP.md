...
Last updated: 2026-02-11 01:10 UTC
...
|--------|-----------|----------|--------|
| core-geth | 53,154 | TBD | Running |
| besu-etc | 53,153 | TBD | Running |
| nethermind-etc | 53,153 | TBD | Running |

- **Total:** 159,460 tests completed (170 failures)
- **Rate:** ~25 tests/min (all clients combined), ~8.3 tests/min per client
- **Elapsed:** 108h / 4.5 days (started 2026-02-06 13:07 UTC)
- **Current test:** `sstore_combinations_initial20` — SSTORE combination tests (Istanbul/Berlin)
- **Fork coverage:** Frontier (3,624), Homestead (6,894), EIP150 (4,122), EIP158 (4,125), Byzantium (15,456), Constantinople (32,922), ConstantinopleFix (32,907), Istanbul (27,615), Berlin (30,781)
...
- **Note:** 159.5k tests (53.2k per client). 108h / 4.5 days. In sstore_combinations_initial20 for Istanbul/Berlin. Failures stable at 170.
