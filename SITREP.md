...
Last updated: 2026-02-10 01:49 UTC
...
|--------|-----------|----------|--------|
| core-geth | 41,643 | TBD | Running |
| besu-etc | 41,643 | TBD | Running |
| nethermind-etc | 41,643 | TBD | Running |

- **Total:** 124,929 tests completed (148 failures)
- **Rate:** ~26 tests/min (all clients combined), ~8.6 tests/min per client
- **Elapsed:** 84h / 3.5 days (started 2026-02-06 13:07 UTC)
- **Current test:** `randomStatetest66-69` — random state tests (Istanbul/Berlin)
...
- **Note:** Approaching 125k tests (41.6k per client). 84h / 3.5 days. Failures stable at 148.
