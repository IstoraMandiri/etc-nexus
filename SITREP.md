...
Last updated: 2026-02-11 05:14 UTC
...
|--------|-----------|----------|--------|
| core-geth | 55,041 | TBD | Running |
| besu-etc | 55,041 | TBD | Running |
| nethermind-etc | 55,041 | TBD | Running |

- **Total:** 165,123 tests completed (170 failures)
- **Rate:** ~25 tests/min (all clients combined), ~8.3 tests/min per client
- **Elapsed:** 112h / 4.7 days (started 2026-02-06 13:07 UTC)
- **Current test:** `sstore_combinations_initial21` — SSTORE combination tests (Istanbul/Berlin)
- **Fork coverage:** Frontier (3,624), Homestead (6,894), EIP150 (4,122), EIP158 (4,125), Byzantium (15,456), Constantinople (32,922), ConstantinopleFix (32,907), Istanbul (30,489), Berlin (33,568)
...
- **Note:** 165.1k tests (55k per client). 112h / 4.7 days. In sstore_combinations_initial21 for Istanbul/Berlin. Istanbul/Berlin now exceed Constantinople levels — these forks have more sstore-specific tests. Failures stable at 170.
