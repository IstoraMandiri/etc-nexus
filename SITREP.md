...
|--------|-----------|----------|--------|
| core-geth | 52,660 | TBD | Running |
| besu-etc | 52,660 | TBD | Running |
| nethermind-etc | 52,660 | TBD | Running |

- **Total:** 157,980 tests completed (170 failures)
- **Rate:** ~25 tests/min (all clients combined), ~8.3 tests/min per client
- **Elapsed:** 107h / 4.5 days (started 2026-02-06 13:07 UTC)
- **Current test:** `sstore_combinations_initial11_2` — SSTORE combination tests (Istanbul/Berlin)
- **Fork coverage:** Frontier (3,624), Homestead (6,894), EIP150 (4,122), EIP158 (4,125), Byzantium (15,456), Constantinople (32,922), ConstantinopleFix (32,907), Istanbul (26,908), Berlin (30,008)
...
- **Note:** 158k tests (52.7k per client). 107h / 4.5 days. In sstore_combinations_initial11_2 for Istanbul/Berlin. Berlin passed 30k tests. Failures stable at 170.
