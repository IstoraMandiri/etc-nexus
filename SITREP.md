...
## Currently Running (2026-01-30 10:49 UTC)

### core-geth: `legacy-cancun` suite

| Metric | Value |
|--------|-------|
| Progress | 8,427 / 111,983 (7.5%) |
| Passed | 8,427 |
| Failed | 0 |
| Rate | ~42 tests/minute |
| ETA | ~41 hours remaining |
...
|-------|-----------|----------|------------|--------|
| legacy (32,616) | 99.94% | 🔄 6.5% (~44h) | - | - |
| legacy-cancun (~27k) | 🔄 7.5% (~41h) | - | - | - |
