...
Last updated: 2026-02-11 13:22 UTC
...
|--------|-----------|----------|--------|
| core-geth | 58,943 | TBD | Running |
| besu-etc | 58,942 | TBD | Running |
| nethermind-etc | 58,943 | TBD | Running |

- **Total:** 176,828 tests completed (174 failures)
- **Rate:** ~25 tests/min (all clients combined), ~8.3 tests/min per client
- **Elapsed:** 120h / 5 days (started 2026-02-06 13:07 UTC)
- **Current test:** `ecpairing` — EC pairing precompile tests (Istanbul/Berlin)
- **Fork coverage:** Frontier (3,924), Homestead (7,194), EIP150 (4,422), EIP158 (4,425), Byzantium (15,756), Constantinople (33,222), ConstantinopleFix (33,207), Istanbul (35,248), Berlin (38,416)
...
- **Note:** **5 days / 120h milestone.** 176.8k tests (58.9k per client). Running ecpairing precompile tests (Istanbul/Berlin). Failures stable at 174.
