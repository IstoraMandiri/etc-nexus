...
|--------|-----------|----------|--------|
| core-geth | 13,295 | TBD | Running |
| besu-etc | 13,295 | TBD | Running |
| nethermind-etc | 13,295 | TBD | Running |

- **Total:** 39,885 tests completed (34 failures)
- **Rate:** ~26 tests/min (all clients combined), ~8.6 tests/min per client
- **Elapsed:** 25h 58m (started 2026-02-06 13:07 UTC)
- **Current test:** `static_CheckOpcodes5` — opcode validation tests (Byzantium/Constantinople/ConstantinopleFix)
- **Fork coverage:** Frontier (1,947), Homestead (4,125), EIP150 (2,196), EIP158 (2,628), Byzantium (8,484), Constantinople (10,258), ConstantinopleFix (10,245)
...
- **Note:** Past 39k tests. No new failures since 10k mark. Istanbul/Berlin still not reached. 26h elapsed.
