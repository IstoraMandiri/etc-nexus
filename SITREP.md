...
## Currently Running (2026-01-30 15:54 UTC)

### core-geth: `legacy-cancun` suite

| Metric | Value |
|--------|-------|
| Progress | 21,688 / 111,983 (19.4%) |
| Passed | 21,688 |
| Failed | 0 |
| Rate | ~44 tests/minute |
| ETA | ~34 hours remaining |
...
|-------|-----------|----------|------------|--------|
| legacy (32,616) | 99.94% | 🔄 17.2% (~38h) | - | - |
| legacy-cancun (~27k) | 🔄 19.4% (~34h) | - | - | - |
