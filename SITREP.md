...
Last updated: 2026-02-03 09:41 UTC
...
| besu-etc | legacy | 32,616 | ~25459 | - | ~78.1% | ~22h | 🔄 Running |
| besu-etc | full consensus | 111,983 | ~4710 | - | ~4.2% | ~447h | 🔄 Running |
...
- Progress: 25459 / 32,616 (78.1%)
- Rate: ~5.4 tests/min | ETA: ~22h

**besu-etc: full consensus** (started Feb 2, 14:06 UTC)
- Progress: 4710 / 111,983 (4.2%)
- Rate: ~4.0 tests/min | ETA: ~22h
